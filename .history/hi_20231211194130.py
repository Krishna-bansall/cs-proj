...
def main():
    ...
    if page_option == "Edit Document":
        ...
        button_col = st.column()
        save_button = button_col.button("Save", help="Save the document")
        clear_button = button_col.button("Clear", help="Clear the document")
        download_button = button_col.button("Download", help="Download the compressed document")
